"""
transitions_ros machine executor app launch file.
...
def generate_launch_description():
    ...
    config = os.path.join(
        get_package_share_directory('transitions_ros'),
        'config',
        'machine_executor.yaml'
    )
    ...
    nm_launch_arg = DeclareLaunchArgument(
        'name',
        default_value='machine_executor')
    ...
    node = Node(
        ...
        package='transitions_ros',
        executable='machine_executor_app',
        name=nm,
        namespace=ns,
        emulate_tty=True,
        output='both',
